          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-12 xl:p-16">
            ...
            <div className="max-w-lg">
              ...
              <p className="mt-6 max-w-md text-base leading-7 text-blue-100/80">
                Create your CampusCare account and report campus issues,
                track complaints and stay connected with your administration.
              </p>
          ...
          <div className="relative z-10 w-full max-w-md">
            ...
            <div className="mb-8 text-center lg:text-left">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Join CampusCare and start reporting campus issues.
              </p>
            ...
            <div className="rounded-3xl border border-slate-200/80 bg-white p-7 shadow-[0_25px_70px_-25px_rgba(15,23,42,0.18)] sm:p-9">
              ...
              {success && (
                <div className="mb-6 flex items-start gap-3 rounded-2xl border border-green-100 bg-green-50 px-4 py-3.5 text-sm font-medium text-green-600">
                  <span className="mt-0.5">✓</span>
                  <span>{success}</span>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-10 pr-4 text-sm uppercase text-slate-900 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    />

                  </div>

                  <p className="mt-1.5 text-xs text-slate-400">
                    Use the college code provided by your college.
                  </p>
                </div>
