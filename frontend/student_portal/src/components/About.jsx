    ...
    >
      ...
      <div className="relative grid w-full items-center gap-12 lg:grid-cols-2 lg:gap-16">
        ...
        <div className="relative flex justify-center lg:justify-end">
         ...
         <div className="float-card relative w-full max-w-md rounded-3xl border border-slate-200/80 bg-white/80 p-7 shadow-[0_25px_60px_-20px_rgba(15,23,42,0.25)] backdrop-blur-xl sm:p-9">
